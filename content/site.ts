...
export const site = {
  ...
  about: {
    ...
    // 自己紹介（出身・歩み・人となり）
    personal: {
      ja: "鹿児島で生まれ、幼稚園の4年間をインドネシア・スラバヤで、小学校のうち3年間は同級生もいないような離島で過ごしました。中学から鹿児島ラ・サール中学・高校へ進み、京都大学理学部へ。大学時代はマジックにのめり込み、マジックバーに出演したり、コンテストに出たりしていました。大学院では宇宙物理学の研究に没頭し、超巨大ブラックホールの光度変動を利用した研究で博士号を取得しました。いまは生成AIに惚れ込んで毎日のように使い込みながら、マジック・旅・ものづくりと、興味の向くままに手を動かしています。物理的な緻密な議論も、マジックのようになんでもありで実現するような大胆なことも、両方とも好きです。",
